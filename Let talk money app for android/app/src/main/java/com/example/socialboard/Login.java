...
public class Login extends AppCompatActivity {
    ...
    Button createAccountBtn, loginBtn, anonymousLoginBtn;
...
//         Configure Google Sign In
                        ...
                        .addOnCompleteListener(Login.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    userInfo.put("FirstName", user.getDisplayName());
                                    userInfo.put("LastName", user.getDisplayName());
                                    userInfo.put("Email", user.getEmail());
                                    userInfo.put("UserRole", "Customer");
                                    userInfo.put("RegisteredOn", new Date());
                                    df.set(userInfo);
                                    Toast.makeText(Login.this,"Login Success! as "+user.getEmail(), Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(getApplicationContext(), Board.class));
                                    finish();
                                } else {
        ...
        createAccountBtn.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), com.example.socialboard.Register.class);
